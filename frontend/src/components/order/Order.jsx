        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className={`w-full py-3 px-4 rounded-md text-white font-medium ${isSubmitting ? 'bg-gray-400' : 'bg-black hover:bg-gray-800'}`}
            >
          ...
          <div className="bg-white p-6 rounded-lg shadow border border-gray-200 sticky top-4">
            ...
            <div className="border-t border-gray-200 pt-4 mt-4 space-y-3">
              ...
              <div className="flex justify-between">
                <span>Доставка</span>
                <span>
                  {formData.deliveryMethod === 'pickup' ? 'Бесплатно' : 'Рассчитывается отдельно'}
                </span>
              </div>
