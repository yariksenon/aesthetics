...
const TelegramBlock = () => (
	<div className='w-full md:w-[20%] py-[2%]'>
		...
		<a
			href='https://t.me/Aesthetics_Market'
			target='_blank'
			rel='noopener noreferrer'
			className='text-sky-500 text-base md:text-lg lg:text-xl custom-underline cursor-pointer'
		>
			Aesthetics_Market
		</a>{' '}
		<br />
		<a
			href='https://t.me/Aesthetics_Market_bot'
			target='_blank'
			rel='noopener noreferrer'
			className='text-sky-300 text-base md:text-lg lg:text-xl custom-underline'
		>
			Aesthetics_Market_bot
		</a>
	</div>
)
...
const InstagramBlock = () => (
	<div className='w-full md:w-[20%] md:border-r-2 py-[2%]'>
		...
		<a
			href='https://www.instagram.com/aestheticsss.shop/'
			target='_blank'
			rel='noopener noreferrer'
			className='text-pink-700 text-base md:text-lg lg:text-xl custom-underline'
		>
			aestheticsss.shop
		</a>
	</div>
		...
		>
			{reviews.map((review, index) => (
				<motion.div
					...
					animate={{
						x: activeReview === index ? '0%' : '100%',
						opacity: activeReview === index ? 1 : 0,
					}}
					transition={{ duration: 0.5 }}
				>
					<p className='text-white text-xl md:text-1xl lg:text-2xl px-4 text-center'>
						{review}
					</p>
				</motion.div>
			))}
...
const TwitterBlock = () => (
	<div className='w-full md:w-[20%] py-[2%] md:border-l-2'>
		...
		<a
			href='https://x.com/Aesthetic_sshop'
			target='_blank'
			rel='noopener noreferrer'
			className='text-gray-500 text-base md:text-lg lg:text-xl custom-underline'
		>
			Aesthetic_sshop
		</a>
	</div>
						...
						<div className='my-[5%]'>
							...
							>
								<img
									src={Logo}
									alt='Logo'
									className='cursor-pointer w-full transform transition-transform duration-300 ease-in-out hover:scale-110 hover:shadow-lg'
								/>
							</button>
						</div>
